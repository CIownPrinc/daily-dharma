...
// This file is manually maintained (no dev server in this environment).
// When running `npm run dev`, TanStack Router will regenerate it automatically.
...
export interface FileRouteTypes {
  ...
  to: '/' | '/journey' | '/library' | '/parents' | '/sanctuary' | '/settings' | '/story/$slug'
  id:
    | '__root__'
    | '/'
    | '/journey'
